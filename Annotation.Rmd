...
<p style="text-align:justify";>Après avoir masqué les séquences répétées dans tous les assemblages, une annotation est réalisée pour chaque assemblage L'annotation est réalisée avec l'outil BRAKER <a href='biblio.html#annotation1'>[5]</a>. Cet outil prend en input un fichier au format fasta contenant le génome à annoter et un fichier bam contenant les alignements de RNAseq sur le génome. Pour cela une première étape est de réaliser un alignement des fichiers RNAseq sélectionnés avec chaque génome assemblé.</p>
