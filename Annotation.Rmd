...
<p style="text-align:justify";>Après avoir masqué les séquences répétées dans tous les assemblages, une annotation est réalisée pour chaque assemblage L'annotation est réalisée avec l'outil BRAKER <a href='biblio.html#annotation2'>[6]</a>. Cet outil prend en input un fichier au format fasta contenant le génome à annoter et un fichier hints.Gff.</p>
