---
title: "Qualité des Assemblages des souches des terrasses"
...
<p style="text-align:justify";>Dans un premier temps les 66 souches sont assemblées avec l'outil ABYSS. Plusieurs assemblages sont effectués pour chaque souche avec différentes tailles de k-mère. Puis le meilleur assemblage de chaque souche est sélectionné. La sélection se fait après visualisation des données de qualité de chaque assemblage. Ces données qualités sont présentées dans la suite du rapport.</p>

<p style="text-align:justify";>Les différents assemblages ont été lancé avec le script <a href="https://floriancha.github.io/Script/index.html" target="_blank">ABYSS_launch</a>. Les données qualités utilisées pour sélectionner le meilleur assemblage ont été récupéré avec le script <a href="https://floriancha.github.io/Script/index.html" target="_blank">Qualtiy</a>.</p>
...
write.table(data_export, col.names = NA, file = "dataABYSS.txt")
```
...
<p style="text-align:justify";>Dans un premier temps, les graphiques avant sélection du kmère optimal vont être créés pour confirmer le choix du meilleur assemblage par rapport aux autres statistiques de qualité. Les souches sont en abscisse tandis que la statistique étudiée est en ordonnée. Les points en rouge sont les meilleurs assemblages selectionnés precédemment.</p>
...
<p style="text-align:justify";> Ensuite les graphiques qui montrent les principales statistiques de qualité des assemblages après sélection du kmère optimale sont montrés. Une différence est constatée entre deux groupes. Cela montre que certains assemblages sont de mauvaise qualité. Une sélection des assemblages avec un N50 supérieur à 25 000 est réalisée. Sur le graphique n°6 cela correspond au point au-dessus de la ligne horizontale rouge.</p>
